...
# Try to register DejaVu for better accents
try:
...
# Helper to format numbers PT
def fmt_pt(value):
    # value float
    s = f"{value:,.2f}"
    # US: 1,234,567.89 -> PT: 1.234.567,89
    s = s.replace(",", "X").replace(".", ",").replace("X", ".")
    return s

# Data for 28 items - cleaned descriptions
items_data = [
    ...
    {"item":10, "ref":"4240400\n(IKA C-MAG HS 10)", "desc":"IKA C-MAG HS 10 — agitador magnético com aquecimento, placa cerâmica (até 15 L H₂O; segurança 550 °C; LED; DIN 12878).", "pais":"África do Sul (RSA)", "tempo":"30 Dias Úteis", "qtd":2, "un":"UN", "pu":330997.17},
    {"item":11, "ref":"3581200\n(IKA C-MAG HS 7)", "desc":"IKA C-MAG HS 7 — agitador magnético com aquecimento, placa cerâmica (até 10 L H₂O; segurança 550 °C; LED; DIN 12878).", "pais":"África do Sul (RSA)", "tempo":"30 Dias Úteis", "qtd":1, "un":"UN", "pu":208177.84},
    ...
    {"item":14, "ref":"VISISCOPE\nBL224PL T1", "desc":"Microscópio digital composto VISISCOPE® BL224PL T1 (contraste de fase e fundo claro, câmara digital T1).", "pais":"África do Sul (RSA)", "tempo":"30 Dias Úteis", "qtd":1, "un":"UN", "pu":271794.59},
    {"item":15, "ref":"LX-165T2-J\n+ rotor 24×1,5/2,0 mL\n+ rotor hematócrito", "desc":"Microcentrífuga de hematócrito (comando independente de velocidade e tempo; motor DC brushless; função pulse; rotor de hematócrito 24 capilares a 12 000 rpm e rotor para 24 tubos 1,5/2,0 mL a 14 000 rpm; 200–12 000 rpm; FCR máx. 13 680; 8,5–10,5 kg; 364×280×274 mm). Inclui montagem e formação.", "pais":"China", "tempo":"90 Dias Úteis", "qtd":1, "un":"UN", "pu":150105.93},
    ...
    {"item":18, "ref":"MSV-3500 &\nSV-4/30", "desc":"Vortex digital multitubos 300–3 500 rpm (tubos 0,2–50 mL; plataformas não incluídas) e plataforma SV-4/30 para 4×50 mL (Ø 30 mm).", "pais":"África do Sul (RSA)", "tempo":"30 Dias Úteis", "qtd":1, "un":"UN", "pu":153477.57},
    {"item":19, "ref":"Duo 60\n(7-em-1) 6 L", "desc":"Panela de pressão 6 L em aço inoxidável, painel digital, função Keep Warm, válvula de segurança — inclui cuba interior em inox e grelha de vapor.", "pais":"África do Sul (RSA)", "tempo":"30 Dias Úteis", "qtd":2, "un":"UN", "pu":51671.60},
    {"item":20, "ref":"DE-45\n(ref. fabr. 1545)", "desc":"Autoclave vertical de laboratório 45 L, 140 °C / 4 bar, câmara em 316L — inclui cesto em aço inoxidável adicional e kit de documentação digital.", "pais":"África do Sul (RSA)", "tempo":"30 Dias Úteis", "qtd":1, "un":"UN", "pu":2440717.96},
    {"item":21, "ref":"LTC4R\n(GRANT TX150-R4R)", "desc":"GRANT LTC4R — banho circulante refrigerado/aquecido TX150-R4R, –30 °C a +100 °C, 20 L, ±0,1 °C, caudal 18 L/min, 1,84 kW, com mangueiras e clips.", "pais":"Reino Unido", "tempo":"30 Dias Úteis", "qtd":1, "un":"UN", "pu":2086383.32},
    ...
    {"item":24, "ref":"PH800\n(Apera)", "desc":"Apera PH800 — kit pH-metro de bancada (calibração 1–3 pontos; monitorização do eléctrodo; GLP 500 conjuntos; USB; software PC-Link; eléctrodo 201T-F).", "pais":"África do Sul (RSA)", "tempo":"30 Dias Úteis", "qtd":10, "un":"UN", "pu":76248.05},
    ...
    {"item":26, "ref":"CNW-TYI304\n(Coplin vidro c/ tampa)", "desc":"Cuba de coloração (Coplin) em vidro com tampa.", "pais":"África do Sul (RSA)", "tempo":"30 Dias Úteis", "qtd":5, "un":"UN", "pu":6007.57},
    {"item":27, "ref":"613-7138\n(VWR EHP)", "desc":"VWR EHP — micropipeta mecânica monocanal, volume variável 1 000–10 000 µL (autoclavável; resistente a UV).", "pais":"África do Sul (RSA)", "tempo":"30 Dias Úteis", "qtd":20, "un":"UN", "pu":42825.09},
    {"item":28, "ref":"BLBIO-SJA\n7.000 L", "desc":"Biofermentador anaeróbico 6 000–7 000 L em AISI 316L, CIP/SIP, painel digital Siemens — inclui sparger N₂ e sensores de pH/nível.", "pais":"África do Sul (RSA)", "tempo":"30 Dias Úteis", "qtd":1, "un":"UN", "pu":35309742.83},
]
...
style_title = ParagraphStyle(
    ...
    fontName=FONT_BOLD, fontSize=11, textColor=DARK_GREEN,
    leading=13, spaceBefore=6, spaceAfter=6, alignment=TA_LEFT,
    keepWithNext=True
)
style_heading2 = ParagraphStyle(
    'Heading2Green', parent=styles['Heading2'],
    fontName=FONT_BOLD, fontSize=10, textColor=DARK_GREEN,
    leading=12, spaceBefore=8, spaceAfter=4, alignment=TA_LEFT
)
style_normal = ParagraphStyle(
    'NormalJustify', parent=styles['Normal'],
    fontName=FONT_NORMAL, fontSize=8.5, leading=11.5,
    alignment=TA_JUSTIFY, spaceBefore=2, spaceAfter=2,
    textColor=colors.HexColor("#222222")
)
style_normal_small = ParagraphStyle(
    'NormalSmall', parent=style_normal,
    fontSize=7.5, leading=10
)
style_bullet = ParagraphStyle(
    'Bullet', parent=style_normal,
    leftIndent=12, firstLineIndent=0, bulletIndent=6,
    spaceBefore=2, spaceAfter=1
)
style_table_cell = ParagraphStyle(
    'TableCell', parent=styles['Normal'],
    fontName=FONT_NORMAL, fontSize=6.5, leading=7.5,
...
style_table_header = ParagraphStyle(
    ...
    fontName=FONT_BOLD, fontSize=6.5, leading=7.5,
...
style_footer = ParagraphStyle(
    ...
    fontName=FONT_NORMAL, fontSize=5.5, leading=6.5,
    textColor=colors.HexColor("#333333"), alignment=TA_LEFT
)
style_caption = ParagraphStyle(
    'Caption', parent=styles['Normal'],
    fontName=FONT_BOLD, fontSize=7, leading=8,
    textColor=DARK_GREEN, alignment=TA_LEFT, spaceBefore=3, spaceAfter=6
)
...
def header_footer(canvas, doc):
    ...
    total_pages = 20
    # Top header: Infinity logo on right
    try:
        # Draw logo if exists
        logo_path = "/tmp/infinity_logo.png"
        if os.path.exists(logo_path):
            canvas.drawImage(logo_path, PAGE_W - 135, PAGE_H - 55, width=95, height=15, preserveAspectRatio=True, mask='auto')
    except:
        pass
    # Header line decorative? faint
    # Footer line
    y_footer_line = 38
    ...
    canvas.setFont(FONT_NORMAL, 5.2)
    ...
    canvas.drawRightString(PAGE_W - MARGIN_RIGHT, y_footer_line-16, f"Página {page_num} de {total_pages}")
    # Bottom gradient bar
    # Draw footer bar with gradient simulation (solid green)
    bar_y = 0
    bar_h = 12
    canvas.setFillColor(HexColor("#0e7a3a"))
    canvas.rect(0, bar_y, PAGE_W, bar_h, stroke=0, fill=1)
    # Add subtle overlay for gradient effect
    canvas.setFillColor(HexColor("#1a9a4a"))
    canvas.setFillAlpha(0.6)
    canvas.rect(0, bar_y+4, PAGE_W*0.4, bar_h-4, stroke=0, fill=1)
    canvas.setFillAlpha(1)
    # Infinity pattern in bar - simple circles
...
def header_footer_landscape(canvas, doc):
    ...
    try:
        logo_path = "/tmp/infinity_logo.png"
        if os.path.exists(logo_path):
            canvas.drawImage(logo_path, pw - 135, ph - 40, width=95, height=15, preserveAspectRatio=True, mask='auto')
    except:
        pass
    y_footer_line = 28
    canvas.setStrokeColor(DARK_GREEN)
    canvas.setLineWidth(0.6)
    canvas.line(28, y_footer_line+14, pw - 28, y_footer_line+14)
    canvas.setFont(FONT_NORMAL, 5.2)
    canvas.setFillColor(colors.HexColor("#222222"))
    canvas.drawString(28, y_footer_line+6, "Infinity Health, SA")
    canvas.setFont(FONT_NORMAL, 4.8)
    canvas.drawString(28, y_footer_line-2, "Rua de França, n.º 273, Bairro da Coop - Maputo")
    canvas.drawString(28, y_footer_line-8, "Maputo")
    ...
    canvas.setFont(FONT_NORMAL, 5.5)
    canvas.setFillColor(DARK_GREEN)
    canvas.drawRightString(pw - 28, y_footer_line-16, f"Página {page_num} de {total_pages}")
    bar_y = 0
    bar_h = 12
    canvas.setFillColor(HexColor("#0e7a3a"))
...
def build_pdf(filename):
    # Create doc with 17 pages, but we need to handle page 16 landscape separately
    # Approach: build story for pages 1-15, 17 as portrait, page 16 will be added via separate canvas or via onLaterPages handling
    # Simpler: create a base doc portrait, generate all portrait pages, then insert landscape page 16 via a hack: generate a temporary landscape PDF and merge
    # But easier: generate everything as one doc portrait, but for page 16 we will use a wider table with smaller font that still fits portrait (we tried). Let's generate portrait version first and see if it fits.
    # However to guarantee visibility requirement, we will make page 16 landscape by using a custom page template.
    # We'll create two docs and merge via PyMuPDF at end.
    from reportlab.platypus import NextPageTemplate

    # We'll create a single doc with alternating templates
    doc = SimpleDocTemplate(filename, pagesize=A4,
                            leftMargin=MARGIN_LEFT, rightMargin=MARGIN_RIGHT,
                            topMargin=MARGIN_TOP, bottomMargin=MARGIN_BOTTOM,
                            title="Proposta Técnica & Financeira - IIAM 35A003641/CP/03/2026",
                            author="Infinity Health, SA")

    story = []

    # ========== PAGE 1 - COVER ==========
    # We will add cover as a full page image plus text via a special first page function
    # For platypus, we can add a spacer and then manually draw cover via onFirstPage
    # Instead, we will handle cover via a custom Page function that draws everything
    # Let's add a PageBreak with cover content as flowables that will be drawn, but we will use onFirstPage to draw background

    # Define onFirstPage for cover
    def cover_page(canvas, doc):
        canvas.saveState()
        pw, ph = A4
        # Background light beige
        canvas.setFillColor(HexColor("#fdfcfa"))
        canvas.rect(0,0,pw,ph, stroke=0, fill=1)
        # Draw leaves using the cover image as background elements
        # Use cover image at low opacity as decorative border
        # Clean cover background - soft beige
        canvas.setFillColor(HexColor("#fdfcf8"))
        canvas.rect(0,0,pw,ph, stroke=0, fill=1)
        # Decorative leaves - left vertical
        try:
            ...
            pass
        # White central card with subtle shadow
        ...
        # Infinity footer on cover
        canvas.setFont(FONT_BOLD, 9)
        canvas.setFillColor(DARK_GREEN)
        # Draw infinity logo text
        canvas.setFont(FONT_BOLD, 14)
        canvas.setFillColor(HexColor("#0e6b2e"))
        # Use image for logo at bottom left
        try:
        ...
        # Decorative bottom leaves already part of background
        canvas.restoreState()

    # We'll use cover_page as onFirstPage, and header_footer for rest
    # To simulate cover as first page, we add a dummy story element that forces cover drawing
    # Add a spacer that will push content to next page after cover
    # The cover Page function will draw everything, we just need to add content for cover as empty
    # Then next pages will be normal

    # Cover content is drawn entirely via canvas, so we add a paragraph that is empty to occupy page
    story.append(Spacer(1, 480))
    # Add cover subtitle inside story? Already drawn via canvas, so no need
    ...
    canvas_line_spacer = Spacer(1, 2)
    # Draw line under title
    # We'll add table for index
    idx_data = [
        ...
        [Paragraph('<font color="#0f5d2e"><b>6.0</b></font>', style_table_cell), Paragraph('<font color="#0f5d2e"><b>PROPOSTA FINANCEIRA</b></font>', style_table_cell), Paragraph('<font color="#0f5d2e"><b>17</b></font>', style_table_cell_right)],
        [Paragraph('<font color="#0f5d2e">&nbsp;&nbsp;6.1</font>', style_table_cell), Paragraph('Planilha de Preços dos Bens', style_table_cell), Paragraph('18', style_table_cell_right)],
        [Paragraph('<font color="#0f5d2e"><b>7.0</b></font>', style_table_cell), Paragraph('<font color="#0f5d2e"><b>REQUISITOS PARA QUALIFICAÇÃO E ANEXOS</b></font>', style_table_cell), Paragraph('<font color="#0f5d2e"><b>20</b></font>', style_table_cell_right)],
    ]
    ...
    idx2_data = [
        ...
        [Paragraph('Tabela 6', style_table_cell), Paragraph('Planilha de preços dos bens', style_table_cell), Paragraph('18', style_table_cell_right)],
    ...
    # ========== PAGE 4 - INFORMAÇÕES DO CONCORRENTE ==========
    ...
    # Tabela 1
    # Using a structured layout: two columns label/value but with merged rows
    info_data = [
    ...
    t_info.setStyle(TableStyle([
        ...
        ('SPAN', (0,3), (0,8)), # merge first column for item 1? Simplified won't merge but visual still okay
    ]))
    story.append(t_info)
    story.append(Spacer(1,6))
    ...
    # Create a grid of brand placeholders
    # Use 4x4 grid with brand names
    brands = [
        ("MGI", "Sequenciação\ngenética"),
    ...
    for name, desc in brands:
        ...
        # Create a bordered cell via Table background
        brand_cells.append(cell_para)
    # Arrange into 4 rows of 4
    grid_data = []
    ...
    # ========== PAGE 9 - TABELA 2 EXEMPLOS ==========
    story.append(Paragraph("Tabela 2. Alguns exemplos de fornecimento de equipamento", style_caption))
    # Example table with 3 institutions
    # We'll include images placeholders
    def img_cell(path, w=110, h=65):
        if os.path.exists(path):
            return Image(path, width=w, height=h)
        else:
            return Paragraph('<font size="6" color="#888888">[Imagem do equipamento]</font>', style_table_cell_center)
    # Try to use actual images if we had, else placeholder text
    ex_data = [
    ...
    # Build Table 4 - first half items 1-14 on page 11, rest on page 12
    # We'll create two tables, one for page 11 (1-14) and one for page 12 (15-28), with a page break between
    ...
    def build_conformidade_table(items_subset):
        ...
        for it in items_subset:
            # Derive short item name from ref/desc - use first words
            # Map item number to short name
            short_names = {
            ...
            # Especificação - use desc but trimmed
            spec_text = it["desc"]
            # Add key specs prefix
            rows.append([
    ...
    # Build Table 5 - we will split into two pages: 1-14 and 15-28
    # Need mapping for brand names
    brand_map = {
    ...
    image_map = {
        ...
        9: "/tmp/product_images/HR1200.png", # placeholder
    ...
    def build_modelo_table(subset):
        ...
        for it in subset:
            ...
            # Short desc for table 5 - more compact than Table 4
            # Use first 180 chars of desc
            compact_desc = it["desc"][:260] + ("…" if len(it["desc"])>260 else "")
            # Create image cell
            img_path = image_map.get(idx, "/tmp/product_images/HR1200.png")
            if os.path.exists(img_path):
                img = Image(img_path, width=58, height=42)
                img.hAlign = 'CENTER'
    ...
    # ========== PAGE 16 - PLANILHA will be handled as landscape in separate doc, we add placeholder here and will replace later
    # For now add a note, the actual planilha will be generated as landscape page
    story.append(Paragraph("6.1. Planilha de Preços dos Bens", style_title))
    story.append(Paragraph("Tabela 6. Planilha de preços — Fornecimento de Diverso Equipamento de Laboratório (valores em Metical, MT)", style_caption))
    story.append(Paragraph("A planilha detalhada, com a discriminação dos preços unitários, dos preços totais sem IVA, do IVA (16 %) e dos preços totais com IVA, é apresentada na página seguinte, em formato paisagem, a fim de garantir a legibilidade integral de todas as colunas, designadamente: <b>Ref.ª, Descrição dos Bens, QTD, Preço Unitário, Preço Total s/ IVA, IVA e Preço Total c/ IVA</b>, em conformidade com o exigido no Caderno de Encargos. Os valores são fixos e não reajustáveis, incluindo o transporte até ao local de entrega, a instalação, a testagem e a formação.", style_normal))
    story.append(Spacer(1,8))
    # Add a summary table in portrait as preview (compact)
    summary_data = [
        [Paragraph('<b><font color="white">RESUMO FINANCEIRO</font></b>', style_table_header), Paragraph('<b><font color="white">VALOR (MT)</font></b>', style_table_header)],
        [Paragraph('Total sem IVA', style_table_cell), Paragraph(f'<b>{total_s_str}</b>', style_table_cell_right)],
        [Paragraph('IVA (16 %)', style_table_cell), Paragraph(f'<b>{total_iva_str}</b>', style_table_cell_right)],
        [Paragraph('<b>Total com IVA</b>', style_table_cell), Paragraph(f'<b><font color="#0f5d2e">{total_c_str}</font></b>', style_table_cell_right)],
    ]
    t_summary = Table(summary_data, colWidths=[250, 150], repeatRows=1)
    t_summary.setStyle(TableStyle([
        ...
        ('ROWBACKGROUNDS', (0,1), (-1,-1), [colors.white, LIGHT_MINT]),
        ('BACKGROUND', (0,3), (-1,3), HexColor("#e0f2e0")),
    ]))
    story.append(t_summary)
    story.append(Spacer(1,8))
    story.append(Paragraph("Nota: A planilha completa, com 28 itens, encontra-se na página 16, em formato paisagem, com todas as colunas visíveis e sem sobreposições, em conformidade com o modelo oficial e com o Mapa de Quantidades anexo ao Caderno de Encargos.", style_normal_small))
    story.append(Paragraph("<i>Ver página seguinte — Planilha de Preços (paisagem).</i>", ParagraphStyle('ItalicCenter', parent=style_normal, alignment=TA_CENTER, textColor=DARK_GREEN, fontName=FONT_BOLD)))
    story.append(PageBreak())
    ...
    for d in docs_b:
        story.append(Paragraph(f"• &nbsp;{d}", style_bullet))
    story.append(Spacer(1,8))
    # Checklist table similar to VFINAL
    ...
    # Build portrait doc (pages 1-15, 16 preview, 17)
    # We need to handle cover separately: first page without header/footer, rest with header_footer
    ...
    print(f"Portrait PDF generated: {filename} with totals {total_c_str}")

# Generate landscape planilha separately
def build_landscape_planilha(filename_land):
    pw, ph = landscape(A4)
    doc = SimpleDocTemplate(filename_land, pagesize=landscape(A4),
                            leftMargin=28, rightMargin=28,
                            topMargin=42, bottomMargin=34,
                            title="Planilha de Preços - IIAM 35A003641/CP/03/2026")
    story = []
    # Title
    story.append(Paragraph("Tabela 6. Planilha de Preços — Fornecimento de Diverso Equipamento de Laboratório", style_caption))
    story.append(Paragraph("Concurso Público N.º 35A003641/CP/03/2026 — Instituto de Investigação Agrária de Moçambique (IIAM) &nbsp; | &nbsp; Moeda: Metical (MT) &nbsp; | &nbsp; IVA: 16 % &nbsp; | &nbsp; Validade: 90 dias &nbsp; | &nbsp; Regime: Preço Global", ParagraphStyle('SubCaption', parent=style_normal_small, alignment=TA_CENTER, textColor=colors.HexColor("#444444"))))
    story.append(Spacer(1,6))
    # Build Table 6 with all 28 items
    # Header
    hdr = [
    ...
    for it in items_data:
        ...
        tot_c = total_s+iva
        rows.append([
            Paragraph(f"{it['item']}", ParagraphStyle('CellC', parent=style_table_cell, alignment=TA_CENTER, fontSize=6)),
            Paragraph(it["ref"].replace("\n","<br/>"), ParagraphStyle('CellRef', parent=style_table_cell_small, alignment=TA_CENTER, fontSize=5.5, leading=6)),
            Paragraph(it["desc"][:280] + ("…" if len(it["desc"])>380 else ""), ParagraphStyle('CellDesc', parent=style_table_cell_small, alignment=TA_LEFT, fontSize=5.2, leading=6)),
            Paragraph(it["pais"], ParagraphStyle('CellPais', parent=style_table_cell_small, alignment=TA_CENTER, fontSize=5.5)),
            Paragraph(it["tempo"], ParagraphStyle('CellTempo', parent=style_table_cell_small, alignment=TA_CENTER, fontSize=5.5)),
            Paragraph(f"{it['qtd']}", style_table_cell_center),
            Paragraph(it["un"], style_table_cell_center),
            Paragraph(fmt_pt(it["pu"]), style_table_cell_right),
            Paragraph(fmt_pt(total_s), style_table_cell_right),
            Paragraph(fmt_pt(iva), style_table_cell_right),
            Paragraph(f"<b>{fmt_pt(tot_c)}</b>", ParagraphStyle('CellBoldRight', parent=style_table_cell_right, fontName=FONT_BOLD)),
        ])
    # Totals row
    rows.append([
        Paragraph('<b>TOTAL</b>', ParagraphStyle('TotalCell', parent=style_table_cell_center, fontName=FONT_BOLD, textColor=colors.white)),
        Paragraph('', style_table_cell),
        Paragraph('<b><font color="white">28 itens — Lote Único</font></b>', ParagraphStyle('TotalDesc', parent=style_table_cell, textColor=colors.white, fontName=FONT_BOLD)),
        Paragraph('', style_table_cell),
        Paragraph('', style_table_cell),
        Paragraph('', style_table_cell),
        Paragraph('', style_table_cell),
        Paragraph('', style_table_cell),
        Paragraph(f'<b><font color="white">{fmt_pt(TOTAL_S_IVA)}</font></b>', ParagraphStyle('TotalRight', parent=style_table_cell_right, textColor=colors.white, fontName=FONT_BOLD)),
        Paragraph(f'<b><font color="white">{fmt_pt(TOTAL_IVA)}</font></b>', ParagraphStyle('TotalRight', parent=style_table_cell_right, textColor=colors.white, fontName=FONT_BOLD)),
        Paragraph(f'<b><font color="white">{fmt_pt(TOTAL_C_IVA)}</font></b>', ParagraphStyle('TotalRight', parent=style_table_cell_right, textColor=colors.white, fontName=FONT_BOLD, fontSize=6.5)),
    ])
    col_widths_land = [26, 70, 205, 52, 52, 24, 24, 62, 66, 60, 68]
    # Adjust to fit page width 842-56=786
    # Sum = 770 approx fits
    ...
    style = TableStyle([
        ...
        ('ALIGN', (0,0), (-1,-1), 'CENTER'),
        ('VALIGN', (0,0), (-1,-1), 'MIDDLE'),
        ('GRID', (0,0), (-1,-1), 0.35, colors.HexColor("#9db99d")),
        ('TOPPADDING', (0,0), (-1,-1), 1.5),
        ('BOTTOMPADDING', (0,0), (-1,-1), 1.5),
    ...
    t_plan.setStyle(style)
    story.append(t_plan)
    story.append(Spacer(1,6))
    legend = """<font size="5.5" color="#333333"><b>Notas:</b> (1) Preços fixos e não reajustáveis, expressos em Metical (MT), com IVA à taxa de 16 % incluído onde aplicável. (2) Os preços incluem o transporte até ao local de entrega (IIAM, Maputo), a instalação, a montagem, a testagem, a calibração inicial e a formação dos técnicos. (3) Garantia mínima de 12 meses; peças sobressalentes por 5 anos. (4) Prazo de entrega: 30 Dias Úteis para origem RSA/Reino Unido/Espanha e 90 Dias Úteis para origem China; prazo máximo global de 90 dias a contar do visto do Tribunal Administrativo. (5) A presente planilha faz parte integrante da Proposta Financeira (página 15, alínea b) e corresponde ao valor global de <b>83.066.935,78 MT</b> com IVA.</font>"""
    story.append(Paragraph(legend, ParagraphStyle('Legend', parent=style_normal_small, alignment=TA_JUSTIFY, fontSize=5.5, leading=7)))
    story.append(Spacer(1,4))
    story.append(Paragraph("Infinity Health, SA — Rua de França, n.º 273, Bairro da Coop, Maputo — NUIT 401550216 — comercial@infinityhealth.co.mz — +258 848770340 / 870867668", ParagraphStyle('FooterLand', parent=style_normal_small, alignment=TA_CENTER, textColor=colors.HexColor("#0f5d2e"), fontName=FONT_BOLD)))
    doc.build(story, onFirstPage=header_footer_landscape, onLaterPages=header_footer_landscape)
    print(f"Landscape planilha generated: {filename_land}")

if __name__ == "__main__":
    out_portrait = "/tmp/Proposta_IIAM_35A003641_CP_03_2026_Portrait.pdf"
    out_land = "/tmp/Planilha_IIAM_35A003641_Landscape.pdf"
    build_pdf(out_portrait)
    build_landscape_planilha(out_land)
